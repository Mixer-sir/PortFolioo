...
export default function UserPortfolio() {
  ...
  const [data, setData] = useState<{ user?: { id: string; username: string }; projects: Project[] }>({ projects: [] });
  ...
  return (
    <div className="container py-10">
      <h1 className="text-3xl font-extrabold tracking-tight">{data.user?.username}</h1>
