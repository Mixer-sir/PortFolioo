        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="mt-4 text-muted-foreground text-lg">
              Минималистичный и адаптивный конструктор портфолио.
              Регистрируйтесь, добавляйте проекты и делитесь ссылкой вида
              /u/username.
            </p>
            ...
            <ul className="mt-8 grid gap-3 text-sm text-muted-foreground">
              <li className="flex items-center gap-2">
                ...
                Регистрация и вход с защитой паролей (bcrypt)
              </li>
              <li className="flex items-center gap-2">
                <span className="h-1.5 w-1.5 rounded-full bg-violet-600" /> CRUD
              ...
              <li className="flex items-center gap-2">
                <span className="h-1.5 w-1.5 rounded-full bg-violet-600" />{" "}
                Совместимо с GitHub Pages (build:docs)
              </li>
            </ul>
          </div>
